...
public interface PoolableObjectFactory {
   ...
   */
  void makeObject(ObjectPoolItem item) throws Exception;
   ...
   * </p>
   *
   * @param item the instance to be destroyed
   * @throws Exception should be avoided as it may be swallowed by
   *    the pool implementation.
   * @see #validateObject
   * @see ObjectPool#invalidateObject
   */
  void destroyObject(ObjectPoolItem item) throws Exception;

  /**
   * Ensures that the instance is safe to be returned by the pool.
   * Returns <code>false</code> if <code>obj</code> should be destroyed.
   *
   * @param item the instance to be validated
   * @return <code>false</code> if <code>obj</code> is not valid and should
   *         be dropped from the pool, <code>true</code> otherwise.
   */
  boolean validateObject(ObjectPoolItem item);

  /**
   * Reinitialize an instance to be returned by the pool.
   * 
   * The return value is optional and not used by the pool itself.
   * 
   * @param item the instance to be activated
   * @param arg optional arguments pass by client when calling borrowObject
   * @return label client or <code>null</code>
   * @throws Exception if there is a problem activating <code>obj</code>,
   *    this exception may be swallowed by the pool.
   * @see #destroyObject
   */
  String activateObject(ObjectPoolItem item, Object arg) throws Exception;

  /**
   * Uninitialize an instance to be returned to the idle object pool.
   *
   * @param item the instance to be passivated
   * @throws Exception if there is a problem passivating <code>obj</code>,
   *    this exception may be swallowed by the pool.
   * @see #destroyObject
   */
  void passivateObject(ObjectPoolItem item) throws Exception;
