...
public abstract class Graphic {
	...
	public byte[] create(FunctionCall plot, RService service, IProgressMonitor monitor) throws CoreException {
	...
	public void create(FunctionCall plot, OutputStream out, RService service, IProgressMonitor monitor) throws CoreException {
		String filename = "plot-"+System.nanoTime()+".plot";
		prepare(filename, service, monitor);
		plot.evalVoid(monitor);
		service.evalVoid("dev.off()", monitor);
